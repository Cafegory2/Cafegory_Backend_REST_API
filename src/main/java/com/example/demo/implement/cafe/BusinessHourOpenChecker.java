...
public class BusinessHourOpenChecker {
    ...
    public boolean checkBetweenBusinessHours(LocalTime businessStartTime, LocalTime businessEndTime,
        ...
        LocalTime truncatedStartTime = timeUtil.localTime(chosenStartTime.getHour(), chosenStartTime.getMinute(), chosenStartTime.getSecond());
        LocalTime truncatedEndTime = timeUtil.localTime(chosenEndTime.getHour(), chosenEndTime.getMinute(), chosenEndTime.getSecond());
