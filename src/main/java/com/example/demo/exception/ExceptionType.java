...
public enum ExceptionType {
	...
	CAFE_STUDY_NOT_FOUND(BAD_REQUEST, "스터디가 존재하지 않습니다."),
	...
	CAFE_STUDY_WRONG_START_DATE(BAD_REQUEST, "카공 시작 날짜는 현재 날짜에서 1달 이내여야 합니다."),
	...
	CAFE_STUDY_LEADER_QUIT_FAIL(CONFLICT, "카공장은 다른 참여자가 있는 경우 참여 취소를 할 수 없습니다."),
	CAFE_STUDY_DELETE_FAIL_MEMBERS_PRESENT(CONFLICT, "카공장은 다른 참여자가 있는 경우 스터디를 삭제 할 수 없습니다."),
	CAFE_STUDY_INVALID_LEADER(BAD_REQUEST, "스터디 리더가 아닙니다."),
